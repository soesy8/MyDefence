...
namespace MySample
{
    ...
    public struct CBox
    {
        public float x;     //x 좌표
        public float y;     //y 좌표
        public float w;     //가로 Width
        public float h;     //세로 heigh
    }
    ...
    public class HitTest : MonoBehaviour
    {
        ...
        //매개변수로 받은 두 개의 Box가 충돌했는지 체크하는 함수
        ...
        //매개변수로 받은 두 개의 Circle이 충돌했는지 체크하는 함수
        //충돌했으면 true 반환, 충돌하지 않았으면 false 반환
        ...
        //도착 판정으로 충돌체크
        //두 오브젝트 간 거리가 일정 거리(0.5f) 안에 있으면 충돌이라고 판정
        //충돌했으면 true 반환, 충돌하지 않았으면 false 반환
